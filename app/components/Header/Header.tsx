    ...
    return (
        <header className='flex'>
            ...
            <div className='flex justify-between bg-[#0b2430] items-center w-5/6'>
                <MdMenu className='cursor-pointer text-slate-300 ml-5' size={45} onClick={onToggleSidebar}/>
                <button className='text-slate-200 text-sm md:text-xl mr-7 md:mr-14'>Sair</button>
            </div>
        </header>
    )
}
